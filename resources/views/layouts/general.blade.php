...
<div class="navbar navbar-inverse">
    <div class="container">
        <div class="navbar-header mt-4">
            ...
            -->
            <a class="navbar-brand" href="/"><img src="{{ asset("assets/images/logo.png") }}" alt="УчёныйКотик"></a>
            <span id="logo-text">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right mainNav">
                <li class="c1 active"><a href="{{ route('index') }}" class="fw-bold no-underline"><i class="fa fa-home"></i>Главная</a></li>
                <li class="c2"><a href="{{ route('events') }}" class="fw-bold no-underline"><i class="fa fa-calendar"></i>Расписание</a></li>
                <li class="c3"><a href="{{ route('UserAuth') }}" class="fw-bold no-underline"><i class="fa fa-pencil"></i>Регистрация</a></li>
                <!--<li class="c8"><a href="/cup" class="fw-bold no-underline"><i class="fa fa-trophy"></i>Победители</a></li>-->
                <li class="c5"><a href="{{ route('info') }}" class="fw-bold no-underline"><i class="fa fa-question-circle"></i>Справка</a></li>
            </ul>
        </div>
        <!--/.nav-collapse -->
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 panel">
                    <div class="panel-body">
                        <p class="simplenav">
                            ...
                            <a href="{{ route('events') }}">Расписание</a> |
                            <a href="{{ route('UserAuth') }}">Регистрация</a> |
                            <a href="{{ route('info') }}">Справка</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 panel">
                    <div class="panel-body">
                        <p class="text-right">
                            <a href="https://vk.com/zorgo" target="_blank">Разработка сайтов</a> by ZORGO &copy;
                        </p>
                    </div>
                </div>
